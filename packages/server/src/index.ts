...
app.get(['/', '/jobs', '/jobs/*', '/printers', '/printers/*', '/workers', '/workers/*', '/settings', '/settings/*', '/login', '/register', '/admin', '/admin/*', '/servers', '/servers/*', '/users', '/users/*', '/API-token', '/API-token/*'], (_req, res) => {
